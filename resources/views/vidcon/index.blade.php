...
<body>
	...
	<main class="card shadow-sm mx-auto p-4">
		...
		<form action="{{ route('group.room.create') }}" class="form-inline justify-content-center" method="post">
				<input type="text" class="form-control col-4 mr-4" id="roomName" name="roomName" placeholder="Room Name" autofocus required>
