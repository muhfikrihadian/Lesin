...
<body>
	...
	<main class="card shadow-sm mx-auto p-4">
		...
		<form action="{{ route('guru.room.create') }}" class="form-inline justify-content-center" method="post">
            {{ csrf_field() }}
				...
				@endif
			<button type="submit" name="button" class="btn btn-primary">Membuat Room</button>
		</form>
	</main>
	<script src="{{ asset('js/jquery.js') }}" charset="utf-8"></script>
	<script src="{{ asset('js/popper.min.js') }}" charset="utf-8"></script>
	<script src="{{ asset('js/bootstrap.min.js') }}" charset="utf-8"></script>
	<script src="{{ asset('js/guru.js') }}" charset="utf-8"></script>
</body>
</html>
